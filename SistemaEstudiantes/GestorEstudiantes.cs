...
public class GestorEstudiantes
{
    ...
    public void OrdenarPorNombre()
    {
        ...
        string.Compare(a.Nombre, b.Nombre, StringComparison.Ordinal));
        Console.WriteLine("Lista ordenada.");
    }

    public void Filtrar(string texto)
    {
        var filtrados = _estudiantes.Where(e => !string.IsNullOrEmpty(e.Nombre) &&
    ...
    public void Listar()
    {
        ...
        Console.WriteLine();
        foreach (var item in _estudiantes) { Console.WriteLine(item); }
    }
}
